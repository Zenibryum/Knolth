...
public class BlockGateXor extends BlockOrientable implements ITileEntityProvider
{
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player)
    {
        //if (!worldIn.isRemote)
        {
            EnumFacing facing = worldIn.getBlockState(pos).getValue(BlockGateXor.FACING);
