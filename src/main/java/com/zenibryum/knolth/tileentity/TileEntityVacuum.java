...
import com.zenibryum.knolth.items.VacuumRecipes;
...
public class TileEntityVacuum extends TileEntityLockable implements ISidedInventory, ITickable{
// enumerate the slots
...
{
  return hasCustomName() ? grinderCustomName : "container.vacuum";
}
...
private boolean canGrind()
{
  ...
  {
      ItemStack itemStackToOutput = VacuumRecipes.instance()
...
public void grindItem()
{
  if (canGrind())
  {
      ItemStack itemstack = VacuumRecipes.instance()
...
{
  // DEBUG
  System.out.println("TileEntityVacuum createContainer()");
  return new ContainerVacuum(playerInventory, this);
}
