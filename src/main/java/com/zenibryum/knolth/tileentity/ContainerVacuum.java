...
public class ContainerVacuum extends Container
{
    ...
    public ContainerVacuum(InventoryPlayer parInventoryPlayer, 
          IInventory parIInventory)
    {
        // DEBUG
        System.out.println("ContainerVacuum constructor()");
        
        tileGrinder = parIInventory;
        sizeInventory = tileGrinder.getSizeInventory();
        addSlotToContainer(new Slot(tileGrinder, 
              TileEntityVacuum.slotEnum.INPUT_SLOT.ordinal(), 56, 35));
        addSlotToContainer(new SlotGrinderOutput(parInventoryPlayer.player, 
              tileGrinder, TileEntityVacuum.slotEnum.OUTPUT_SLOT.ordinal(), 
              116, 35));
    ...
    */
          ...
          int slotIndex)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if (slotIndex == TileEntityVacuum.slotEnum.OUTPUT_SLOT
                  .ordinal())
            {
            ...
            else if (slotIndex != TileEntityVacuum.slotEnum.INPUT_SLOT
                  .ordinal())
            {
