...
public class KnolthBlocks {
    ...
    public static Block gate_and = new BlockOrientable(Material.cactus).setUnlocalizedName("gate_and").setCreativeTab(Knolth.tabKnolth);
    public static Block gate_or = new BlockOrientable(Material.cactus).setUnlocalizedName("gate_or").setCreativeTab(Knolth.tabKnolth);
    public static Block gate_xor = new BlockOrientable(Material.cactus).setUnlocalizedName("gate_xor").setCreativeTab(Knolth.tabKnolth);
    public static Block gate_not = new BlockOrientable(Material.cactus).setUnlocalizedName("gate_not").setCreativeTab(Knolth.tabKnolth);
