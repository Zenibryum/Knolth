...
public class BlockCentrifuge extends BlockContainer
{
    ...
    public Item getItemDropped(
          ...
          int fortune)
    {
        return Item.getItemFromBlock(KnolthBlocks.grinder);
    }
          ...
          float hitZ)
    {
        if (!parWorld.isRemote)
        {
            parPlayer.openGui(Knolth.instance, 
                  Knolth.GUI_ENUM.CENTRIFUGE.ordinal(), 
                  parWorld, 
                  parBlockPos.getX(), 
                  parBlockPos.getY(), 
                  parBlockPos.getZ()); 
    ...
    {
     // DEBUG
     System.out.println("BlockCentrifuge createNewTileEntity()");
    ...
    {
        return Item.getItemFromBlock(KnolthBlocks.centrifuge);
    }
