...
import com.zenibryum.knolth.items.ElectricFurnaceRecipes;
...
public class TileEntityElectricFurnace extends TileEntityLockable implements ISidedInventory, ITickable{
// enumerate the slots
...
{
  return hasCustomName() ? grinderCustomName : "container.electric_furnace";
}
...
private boolean canGrind()
{
  ...
  {
      ItemStack itemStackToOutput = ElectricFurnaceRecipes.instance()
...
public void grindItem()
{
  if (canGrind())
  {
      ItemStack itemstack = ElectricFurnaceRecipes.instance()
...
{
  return "knolth:electric_furnace";
}
...
{
  // DEBUG
  System.out.println("TileEntityElectricFurnace createContainer()");
