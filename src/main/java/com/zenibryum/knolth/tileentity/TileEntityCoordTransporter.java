...
import com.zenibryum.knolth.CoordEntry;
...
public class TileEntityCoordTransporter extends TileEntity{
	...
	public void addEntry(String name, ItemStack ItemTesttube)
	{
		NBTTagCompound nbt = (NBTTagCompound) ItemTesttube.getTagCompound().getTag("coords");
